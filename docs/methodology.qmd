...
1. **Missing Factors**: Analysis doesn't account for political economy, donor fatigue, economic conditions
2. **Media Bias**: GDELT reflects English-language news; may not capture all regional coverage
3. **Displacement Types**: DTM focuses on internal displacement; doesn't include refugees or asylum seekers

# Future Directions

## Methodological Extensions

1. **Country-Level Analysis**: Disaggregate to specific crisis contexts
2. **Keyword Sensitivity**: Test multiple GDELT search terms
3. **Lag Analysis**: Investigate time delays between media spikes and funding responses
4. **Multivariate Modeling**: Include economic indicators, political events, donor fatigue metrics

## Research Questions

1. Can we develop a **Funding Stress Index** predicting volatility?
2. How do different crisis types (natural disasters vs. conflict) affect funding-media relationships?
3. What role do social media patterns play alongside traditional news coverage?
4. Can machine learning predict funding shortfalls before they occur?

## Data Enhancements

1. **Longer Time Series**: Extend to 5-10 years for robust trend detection
2. **Additional Sources**: Integrate ACLED (conflict data), ReliefWeb, HDX indicators
3. **Real-Time Monitoring**: Build automated pipeline for continuous analysis
4. **Donor-Level Analysis**: Examine individual donor behavior patterns
...
- **Documentation**: [Quarto website](https://yourusername.github.io/humanitarian-funding-analysis)
